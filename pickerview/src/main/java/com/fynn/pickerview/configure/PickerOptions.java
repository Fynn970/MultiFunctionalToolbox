package com.fynn.pickerview.configure;
...
import com.fynn.pickerview.listener.OnOptionsSelectChangeListener;
import com.fynn.pickerview.listener.OnOptionsSelectListener;
...
public class PickerOptions {
    ...
    public boolean[] starType = new boolean[]{true, true, true, true, true, true, true};
    ...
    public List<Integer> weekType;//0代表周日  1代表周一  一次类推
    public boolean cyclic = false;//是否循环
    public boolean isLunarCalendar = false;//是否显示农历

    public int startTimePeriodHour;//设置时间段的开始
    public int startTimePeriodMinute;//设置时间段的开始

    public int endTimePeriodHour;//设置时间段的结束
    public int endTimePeriodMinute;//设置时间段的结束
