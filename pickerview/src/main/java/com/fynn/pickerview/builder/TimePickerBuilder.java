package com.fynn.pickerview.builder;
...
import com.fynn.pickerview.configure.PickerOptions;
import com.fynn.pickerview.listener.CustomListener;
import com.fynn.pickerview.listener.OnTimeSelectChangeListener;
import com.fynn.pickerview.listener.OnTimeSelectListener;
import com.fynn.pickerview.view.TimePickerView;
...
public class TimePickerBuilder {
    ...
    public TimePickerBuilder setStarType(boolean[] starType){
        mPickerOptions.starType = starType;
        return this;
    }
     ...
     * 设置禁用日期 0为周日  1为周一
     */
    public TimePickerBuilder setWeekDisableDay(List<Integer> weekDisableDay){
        mPickerOptions.weekType = weekDisableDay;
        return this;
    }
     ...
     * @return
     */
    public TimePickerBuilder setTimeInterval(int interval){
        mPickerOptions.timeinterval = interval;
        return this;
    }
     ...
     * @return
     */
    public TimePickerBuilder setTimePeriod(int startHour, int startMinute, int endHour, int endMinute){
        mPickerOptions.startTimePeriodHour = startHour;
        mPickerOptions.endTimePeriodHour = endHour;
        mPickerOptions.startTimePeriodMinute = startMinute;
        mPickerOptions.endTimePeriodMinute = endMinute;
        return this;
    }
